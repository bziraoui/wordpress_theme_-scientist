<?php
/**
 *Scientist-is-Awesome functions and definitions
 *
...
if ( ! function_exists( 'scientist_is_awesome_setup' ) ) :
	/**
	 ...
	 */
	function scientist_is_awesome_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based onScientist-is-Awesome, use a find and replace
		 * to change 'scientist-is-awesome' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'scientist-is-awesome', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'scientist-is-awesome' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'scientist_is_awesome_custom_background_args', array(
...
add_action( 'after_setup_theme', 'scientist_is_awesome_setup' );
 ...
 */
function scientist_is_awesome_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'scientist_is_awesome_content_width', 640 );
}
add_action( 'after_setup_theme', 'scientist_is_awesome_content_width', 0 );
 ...
 */
function scientist_is_awesome_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'scientist-is-awesome' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'scientist-is-awesome' ),
...
add_action( 'widgets_init', 'scientist_is_awesome_widgets_init' );
